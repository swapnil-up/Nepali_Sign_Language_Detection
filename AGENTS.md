...
| File | Role |
|---|---|
| **MainActivity** | Camera + gesture recognition with MediaPipe LIVE_STREAM mode, practice mode, TTS |
...
**Controls in practice mode**: Exit | Cam | Skip | Stop | Read (speaks target)
